\hypertarget{interface_c_c_ease_elastic_in_out}{\section{C\-C\-Ease\-Elastic\-In\-Out Class Reference}
\label{interface_c_c_ease_elastic_in_out}\index{C\-C\-Ease\-Elastic\-In\-Out@{C\-C\-Ease\-Elastic\-In\-Out}}
}
...
\hypertarget{interface_c_c_ease_elastic_in_out_abb2ba1b2ee7d9691b7211d494a9b98fd}{\index{C\-C\-Ease\-Elastic\-In\-Out@{C\-C\-Ease\-Elastic\-In\-Out}!update\-:@{update\-:}}
\index{update\-:@{update\-:}!CCEaseElasticInOut@{C\-C\-Ease\-Elastic\-In\-Out}}
\subsubsection[{update\-:}]{\setlength{\rightskip}{0pt plus 5cm}-\/ (void) {\bf update\-:} 
\begin{DoxyParamCaption}
\item[{({\bf cc\-Time})}]{time}
\end{DoxyParamCaption}
}}\label{interface_c_c_ease_elastic_in_out_abb2ba1b2ee7d9691b7211d494a9b98fd}
              ...
              : (ccTime) t
{
        ...
        if( t == 0 || t == 1 )
                ...
                t = t -1;
                if( t < 0 )
                        newT = -0.5f * powf(2, 10 * t) * sinf((t - s) * 
      M_PI_X_2 / period_);
                else
                        newT = powf(2, -10 * t) * sinf((t - s) * M_PI_X_2 / 
      period_) * 0.5f + 1;
        }
        [other update:newT];
}
